                                ...
                                <thead>
                                    <tr>
										...
										foreach($markpercentages as $markpercentage) {
												...
												$strt = stripos($markpercentage->markpercentagetype,"Assign");
												
												$strt2 = stripos($markpercentage->markpercentagetype,"Class Test");
												if($strt!== FALSE){
										...
										<?php } ?>
										<?php if( $isassignment == 1) { ?> 
										 <th>Assignmemt Average</th>
										<?php } ?>
                                        ...
                                        <?php if(isset($studentPosition[$student->srstudentID]['subjectMark'][$subject->subjectID])) { ?>
                                            <tr>
												...
												if($strt!== FALSE){
													...
													if(isset($studentPosition[$student->srstudentID]['markpercentageMark'][$subject->subjectID][$markpercentage->markpercentageID]))
													$assignmentTotal += $studentPosition[$student->srstudentID]['markpercentageMark'][$subject->subjectID][$markpercentage->markpercentageID];									$assignmentCount++;
													continue;	
												}
												...
												if($strt2!== FALSE){
													...
													if(isset($studentPosition[$student->srstudentID]['markpercentageMark'][$subject->subjectID][$markpercentage->markpercentageID]))
													$testTotal += $studentPosition[$student->srstudentID]['markpercentageMark'][$subject->subjectID][$markpercentage->markpercentageID];									$testCount++;
													continue;	
												}
												...
												$totaltest += ($testTotal/$testCount);
												 ?> 
										 <td><?php echo number_format($testTotal/$testCount,2); ?></td>
										<?php } ?>
												<?php if( $isassignment == 1) {
												
												$totalassignment += ($assignmentTotal/$assignmentCount);
												 ?> 
										 <td><?php echo number_format($assignmentTotal/$assignmentCount,2); ?></td>
										<?php }
										
										$totalmainminus += 	$assignmentTotal + $testTotal;
										?>
                                                <td><?=isset($studentPosition[$student->srstudentID]['subjectMark'][$subject->subjectID]) ? $studentPosition[$student->srstudentID]['subjectMark'][$subject->subjectID] - (	$assignmentTotal + $testTotal) + ($assignmentTotal/$assignmentCount) + ($testTotal/$testCount) : '0'?></td>
                                                <td>
                                    ...
                                    <tr>
                                        ...
                                        <?php } } ?>
											...
											<?php if( $istest == 1) {
												 ...
												 ?> 
										 <td><?php echo number_format($totaltest,2); ?></td>
										<?php } ?>
											<?php if( $isassignment == 1) {
												
												
												 ?> 
										 <td><?php echo number_format($totalassignment,2); ?></td>
										<?php } ?>
                                        <td><b><?=isset($studentPosition[$student->srstudentID]['totalSubjectMark']) ? $studentPosition[$student->srstudentID]['totalSubjectMark'] + $totaltest + $totalassignment - $totalmainminus  : '0'?></b></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                    </tr>
